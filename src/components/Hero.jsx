    ...
    <section className="relative w-full min-h-screen sm:h-screen overflow-hidden">
      ...
      <div className="relative z-10 h-full px-4 sm:px-6 lg:px-20 xl:px-24 pt-16 sm:pt-20 pb-6 sm:pb-8">
        <div className="max-w-7xl mx-auto h-full flex items-center">
          ...
          <div className="fixed top-1/2 right-2 sm:right-4 lg:right-8 z-30 hidden sm:flex flex-col gap-3 -translate-y-1/2">
          ...
          <div className="w-full min-h-screen sm:h-full flex flex-col lg:flex-row items-center justify-between gap-6 sm:gap-8 lg:gap-12 py-16 sm:py-0">
            ...
            <motion.div
              ...
              className="flex-1 flex flex-col justify-center space-y-3 sm:space-y-4 lg:space-y-6 max-w-3xl lg:max-w-none lg:pr-8"
            >
              ...
              >
                ...
                <motion.a 
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="border-2 border-[#915EFF] text-[#915EFF] px-5 sm:px-8 py-2 sm:py-3 rounded-full font-semibold shadow-lg hover:bg-[#915EFF] hover:text-white transition-all duration-300 text-center backdrop-blur-sm text-xs sm:text-base"
                >
                  Download CV
                </motion.a>
                */}
            ...
            <motion.div 
              ...
              className="flex-1 flex items-end justify-center h-full pb-4 sm:pb-8 lg:pb-16 max-w-lg lg:max-w-none"
            >
              <div className="w-full h-[250px] sm:h-[350px] lg:h-[450px] xl:h-[500px] max-w-[280px] sm:max-w-[400px] lg:max-w-[500px] xl:max-w-[550px] relative">
