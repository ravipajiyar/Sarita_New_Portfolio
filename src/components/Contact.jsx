...
const Contact = () => {
  ...
  return (
    <div className="relative w-full max-w-[2100px] mx-auto px-4 sm:px-6 min-h-screen">
      <div className="flex flex-col xl:flex-row justify-between items-start gap-8">
        {/* Form Section */}
        <motion.div
          variants={slideIn("left", "tween", 0.2, 1)}
          className="w-full xl:w-[45%] bg-black-100/80 backdrop-blur-sm p-5 sm:p-8 rounded-2xl"
        >
          ...
          >
            <label className="flex flex-col">
              ...
              <input
                ...
                className="bg-tertiary py-3 sm:py-4 px-5 sm:px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium text-sm sm:text-base"
                required
              />
            </label>
            <label className="flex flex-col">
            ...
            <button
              type="submit"
              disabled={loading}
              className={`py-2.5 sm:py-3 px-6 sm:px-8 rounded-xl outline-none w-full text-white font-bold shadow-md transition-all duration-300 flex items-center justify-center gap-2 text-sm sm:text-lg ${
                sent
        ...
        <motion.div
          ...
          className="xl:flex-1 xl:h-[700px] md:h-[550px] h-[300px] sm:h-[350px] relative"
        >
          <EarthCanvas />
        </motion.div>
      </div>
